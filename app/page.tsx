    ...
    <main className="flex h-screen flex-col items-center justify-center">
      <section className='chatbot-section flex flex-col origin:w-[800px] w-full origin:h-[735px] h-full rounded-md p-2 md:p-6'>
        <div className='chatbot-header pb-6'>
          ...
          <p className="chatbot-text-secondary-inverse text-sm md:text-base mt-2 md:mt-4">¡Chatea con el chatbot! Simplemente escribe tus preguntas o solicitudes sobre los autos de manera clara y precisa.</p>
        </div>
        ...
        <form className='flex h-[40px] gap-2' onSubmit={handleSend}>
          <input onChange={handleInputChange} value={input} className='chatbot-input flex-1 text-sm md:text-base outline-none bg-transparent rounded-md p-2' placeholder='Envia un mensaje...' />
